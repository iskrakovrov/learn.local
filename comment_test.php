...
$sql = 'SELECT DISTINCT id_acc FROM commentoai';
        ...
        <table id="example" class="cell-border" style="width:100%">
            ...
            foreach ($comm as $a) {
                ...
                <tr>
                    ...
                    <td><?php
                        $sql = "SELECT login_fb FROM accounts WHERE id = $co1";
                        $co = select($sql);
                        echo $co['login_fb'];
                        ?></td>
                    ...
                    <td><?php
                        ...
                        $sql = "SELECT COUNT(*) FROM commentoai WHERE id_acc = $co1 AND posted = 1";
                        $co = select($sql);
                         ?>
                        <a href="pcomm.php?id=<?php echo $co1?>"> <?echo $co['COUNT(*)'] ?></a></td>
                    <td><?php

                        $sql = "SELECT COUNT(*) FROM commentoai WHERE id_acc = $co1 AND posted != 1";
                        $co = select($sql);?>
                        <a href="ucomm.php?id=<?php echo $co1?>"> <?echo $co['COUNT(*)'] ?></a></td>
