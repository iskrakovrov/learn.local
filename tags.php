...
<head>
    ...
    <title>FB Combo Accounts tags</title>
</head>
<body>
<?php
...
<main class="container-fluid ">
    ...
    <div class="row">
        <div class="col text-center">
            <a class="btn btn-secondary" href="add_tags.php" role="button">Add tag</a>
                ...
                <tr>
                    ...
                    <td>
                        <div class="col">
                            ...
                            <a href="dell_tag.php?id=<?php echo $a['id'] ?>" class="btn btn-danger"
                               title="Delete tag"
                               onClick="return confirm( 'WARNING!!! DELETE tag?' )">Delete
                                tag <i class="bi bi-x-circle-fill"></i></a>
                        </div>
                    </td>
                </tr>
            <?php } ?>
