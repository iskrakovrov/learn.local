...
if (isset($_POST['accs'])) {
    ...
    foreach ($array as $pr) {
        $i++;
        $res = parse_acc1($pr, $comm, $serv, $group);
        $sql = $res[0];
    ...
    <div class="row justify-content-center">
        <div class="col-6 text-center">
            ...
            <div class="alert alert-info" role="alert">
                ...
                <a class="btn btn-secondary" href="#" role="button" data-placement="right" title="Если не указали группу" >Add account group</a>
                <br>
                Если не создан сервер
                <br>
                <a class="btn btn-secondary" href="#" role="button" data-toggle="tooltip" data-placement="right" title="Если не указали сервер" >Add Server</a>
                <br>
            </div>
            <form method="post">
