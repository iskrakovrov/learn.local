        ...
        <div class="row justify-content-center">
            <div class="col-sm-2 text-center">
                <form method="post" onSubmit="return Complete();">
                    ...
                    <label for="cat" class="control-label">Groups list</label>
                    ...
                    <label for="num_l">How many groups can I join in one launch?</label>
                    ...
                    <button class="btn btn-secondary" name="add_task" id="add_task" value="join_group">ACTIVATE
                    </button>
