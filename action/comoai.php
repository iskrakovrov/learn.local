        ...
        <div class="row justify-content-center">
            <div class="col-sm-2 text-center">
                <form method="post" onSubmit="return Complete();">
                    ...
                    <br>
                    <label for="coml" class="control-label"><?php echo 'Promts list' ?></label>
                    ...
                    <button class="btn btn-secondary" name="add_task" id="add_task" value="comoai">ACTIVATE
                    </button>
