            ...
            <div class="input-group">
                ...
                <div class="row">
                    <div class="col text-center">
                        <a class="btn btn-secondary" href="add_one_proxy.php" role="button">Add accounts</a>
                        <a class="btn btn-secondary" href="#" role="button">Add task</a>

                        <a class="btn btn-danger" href="#" role="button">Delete Accounts</a>
                    </div>
                </div>
            ...
            <table id="dr_table" class="cell-border" style="width:100%">
                ...
                foreach ($query as $a) {
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="col">
                                <button type="button" class="btn btn-success"><i class="bi bi-pencil-square"></i>
                                </button>

                                <button type="button" class="btn btn-success"><i class="bi bi-star"></i></button>
...
<main class="container-fluid ">
    ...
    <div class="container-fluid">
        ...
        <br>
        <form method="post" action="del_accs.php">
            <div class="input-group">
                <select name="act" class="custom-select">
                    <option value="" selected>[Что делать с отмеченными]</option>
                    <option value="add_task">Добавить задание</option>
                ...
                <div class="row">
                    <div class="col text-center">
                        ...
                        <a class="btn btn-danger" href="#" role="button " onClick="return confirm( 'WARNING!!! DELETE ACCOUNT?' )">Delete Accounts</a>
                        <button class="btn btn-danger" onClick="return confirm( 'WARNING!!! DELETE ACCOUNT?' )" name="del_accs" id = "dell_accs" method="post">DELETE ACCOUNTS</button>
                    </div>
                </div>
                ...
                foreach ($query as $a) {
                    ...
                    <tr>
                        ...
                        <td><?php
                            ...
                            if (!empty($id_mail))
                            {
                                $sql1 = "SELECT * FROM mail WHERE id_mail = '$id_mail'";
                                $query1 = select($sql1);
                                $mail = $query1['mail'];
                            }
                            else
                        ...
                        <td><?php
                            $id_phone = $a['id_phone'];
                            if (!empty($id_phone)){
                                $sql1 = "SELECT * FROM phones WHERE phone_id = '$id_phone'";
                                $query1 = select($sql1);
                                $phone = $query1['phone'];}
                            else{
                                $phone = 'NONE';
