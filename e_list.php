                        ...
                        foreach ($ser as $a) {
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="del_all_val.php?id=<?php echo $a['id'] ?>" class="btn btn btn-danger"
                                       title="Delete values" onClick="return confirm( 'WARNING!!! DELETE LIST?' )"
                                    >Delete values <i class="bi bi-x-circle-fill"></i></a>
